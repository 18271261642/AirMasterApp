...
import com.app.airmaster.action.GridSpaceDecoration;
import com.app.airmaster.action.SingleClick;
import com.app.airmaster.action.StatusAction;
import com.app.airmaster.action.ThreadPoolManager;
import com.app.airmaster.adapter.ImageSelectAdapter;
import com.app.airmaster.dialog.AlbumDialog;
import com.app.airmaster.widget.StatusLayout;
...
public final class ImageSelectActivity extends AppActivity
    ...
    protected void initView() {
        ...
        // 添加分割线
        mRecyclerView.addItemDecoration(new GridSpaceDecoration(3));
        // 设置滚动监听
